...
Process(2).Parameters = {'srcbuffer','display',...  % from display buffer
                        'srcbufnum',1,...           % first of buffer
                        'srcframenum',-1,...        % most recent image
                        'dstbuffer','none'};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
SeqControl(3).argument = 50000;  % 15000 usec = 15msec time between frames
...
for i = 1:Resource.RcvBuffer(1).numFrames
    ...
    n = n+1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Event(n).info = 'noop'; % call external function
    Event(n).tx = 0;
    Event(n).rcv = 0;
    Event(n).recon = 0;
    Event(n).process = 2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
UI(2).Control = {'UserA1','Style','VsToggleButton','Label','Continous Save ST/SP'};
UI(2).Callback = text2cell('%SaveImageCallback');

UI(3).Control = {'UserC3','Style','VsButtonGroup',...
                 'Title','Mode Select',...
                 'NumButtons',6,...
                 'Labels',{'Fist', 'Index', 'Mid', 'Ring', 'Pinky', 'Open'}};
UI(3).Callback = text2cell('%StateChangeCallback');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if UIState == 1
    P.saveImageFlag = 1;
    fprintf("START Saving Frames\n");
else
    P.saveImageFlag = 0;
    fprintf("STOP Saving Frames\n");
end
assignin('base','P',P);
return
%SaveImageCallback
